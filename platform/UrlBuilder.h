...
{
private:
	map<u16string, u16string> m_params;
	u16string m_urlBase;

public:
	UrlBuilder(u16string environment);
	~UrlBuilder();

public:
	void AddParam(const u16string key, const u16string value, bool escape = true);

public:
	bool Build(u16string& url);
};